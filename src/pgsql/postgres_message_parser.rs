...
impl MessageParser for Postgres {
    type MessageType = PostgresMessageData;
    ...
    fn add_to_stream(
        &self,
        stream: &mut StreamData<PostgresMessageData, PostgresStreamGlobals>,
    ...
    ) -> Box<dyn Fn(mpsc::Sender<BgFunc>, PathBuf, MessageInfo<PostgresMessageData>)> {
